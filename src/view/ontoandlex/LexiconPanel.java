...
import controller.ontoAndLex.LexComboCategoryItemListener;
import controller.ontoAndLex.LexAddNewPOSActionListener;
import controller.ontoAndLex.LexMapToNewConcept;
import controller.ontoAndLex.LexNewEntryButtonListener;
import controller.ontoAndLex.LexiconTableKeyListener;
import controller.ontoAndLex.LexiconTableListener;
...
public class LexiconPanel extends JPanel{
	...
	private static LexiconList lexList;
	
	LexiconPanel lexPanel = this;
	
	int currMode;
	
	public LexiconPanel getInstance(){
		return this;
	}
	...
	public static boolean isLexiconExist(String newLexName, int row){
